...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-50">
      <Head>
        <title>Thundra Analytics - Dashboard</title>
      </Head>

      <main className="flex flex-col items-center justify-center w-full flex-1 px-20">
        <button onClick={(e) => handleClick(e, "Profile", "/profile")} class="bg-indigo-600 hover:bg-blue-dark text-white font-bold py-2 px-4 rounded">
          Go to profile
        </button>
